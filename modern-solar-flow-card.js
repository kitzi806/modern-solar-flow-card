...
class ModernSolarFlowCard extends HTMLElement {
      ...
      <div class="diagram-area">
        ...
        <svg id="ms-svg">
            <g id="ms-paths">
                ...
                <!-- G->B goes through home logic visually or behind? -->
  ...
  _drawPaths() {
    ...
    // Grid -> Battery (Straight through home, but lower to not cross center?)
    // Actually, straight line G->B will cross Home.
    // To make it look "through home", we can just draw it straight (behind home circle).
