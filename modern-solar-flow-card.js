...
class ModernSolarFlowCard extends HTMLElement {
  ...
  _drawPaths() {
    ...
    updatePath('#p-flow-s-b', `M ${S.x} ${S.y + S.r + PAD} C ${S.x} ${B.y - 50}, ${B.x} ${B.y - 50}, ${B.x} ${B.y - B.r - PAD}`);
    updatePath('#p-flow-s-g', `M ${S.x} ${S.y + S.r + PAD} C ${S.x} ${G.y - 50}, ${G.x} ${G.y - 50}, ${G.x} ${G.y - G.r - PAD}`);
    updatePath('#p-flow-b-h', `M ${B.x + B.r + PAD} ${B.y} L ${H.x - H.r - PAD} ${H.y}`);
    updatePath('#p-flow-g-h', `M ${G.x - G.r - PAD} ${G.y} L ${H.x + H.r + PAD} ${H.y}`);
    const y_low = H.y + H.r + 20; updatePath('#p-flow-g-b', `M ${G.x} ${G.y + G.r + PAD} C ${G.x} ${y_low}, ${B.x} ${y_low}, ${B.x} ${B.y + B.r + PAD}`);
